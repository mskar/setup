...
alias tta="tmux attach -t $(echo '$(tmux list-sessions | fzf --no-sort | cut -d: -f1)')"
alias tts="tmux switch -t $(echo '$(tmux list-sessions | fzf --no-sort | cut -d: -f1)')"
alias ttk="tmux kill-session -t $(echo '$(tmux list-sessions | fzf -m --no-sort | cut -d: -f1)')"
