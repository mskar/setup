...
alias jjt="func() { local directory=$(echo '$(fasd -Rdl | fzf --delimiter=/ --no-multi --with-nth=4..)') && local session=$(echo '${1:-${directory##*/}}') && tmux switch -t $(echo '$session') || tmux new -ds $(echo '$session') -c $(echo '$directory') && tmux switch -t $(echo '$session') || tmux new -s $(echo '$session') -c $(echo '$directory'); }; func"
...
alias jt="func() { local directory=$(echo '$(fd --type d ^ $@ | fzf --no-multi)') && local session=$(echo '${directory##*/}') && tmux switch -t $(echo '$session') || tmux new -ds $(echo '$session') -c $(echo '$directory') && tmux switch -t $(echo '$session') || tmux new -s $(echo '$session') -c $(echo '$directory'); }; func"
