...
alias hrcp="func() { gh repo create $(echo '$1') --$(echo '${2:-public}') $(echo '${@:3}') -y && cd $(echo '$1'); }; func"
alias hrcd="func() { gh repo create $(echo '$1') --$(echo '${2:-private}') -d $(echo '${*:3}') -y && cd $(echo '$1'); }; func"
alias hrcpd="func() { gh repo create $(echo '$1') --$(echo '${2:-private}') -d $(echo '${*:3}') -y && cd $(echo '$1'); }; func"
