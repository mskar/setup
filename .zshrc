...
alias jt="func() { local file=$(echo '${1:-${PWD##*/}}.py') && touch $(echo '$file') && jupytext --set-kernel $(echo '${2:-python3}') $(echo '$file') && jupytext --to notebook --execute $(echo '$file') && jupytext --set-formats ipynb,Rmd:rmarkdown $(echo '${file/%.py/.ipynb}'); }; func"
