...
alias ec="emacs --daemon -q --load ~/.config/emacs/init.el"
alias ed="emacs --daemon -q --load ~/.doom/doom-emacs/init.el"
...
alias eq="emacs -q"
alias es="emacs --daemon -q --load ~/.emacs.d/init.el"
...
alias jt="func() { local directory=$(echo '$(fd --type d ^ $@ | fzf --no-multi)') && [ $(echo '$directory') ] && [ -d $(echo '$directory') ] && cd $(echo '$directory') && local session=$(echo '${directory##*/}') && [ $(echo '$session') ] && tmux switch -t $(echo '$session') || tmux new -ds $(echo '$session') && tmux switch -t $(echo '$session') || tmux attach -t $(echo '$session') ; }; func"
