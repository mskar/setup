...
export FZF_DEFAULT_OPTS="--bind=change:top,ctrl-k:kill-line,alt-p:toggle-preview,alt-w:toggle-preview-wrap --cycle --exit-0 --inline-info --multi --no-height --no-sort --preview='bat --style=numbers --color=always {} | grep -E \"\$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g)\" --color=always' --preview-window='70%:hidden' --reverse --tiebreak=index"
...
alias ...="cd ../.."
alias ..="cd .."
alias 0="directory=$(echo '$(dirs -v | cut -c3- | sed s+~+$HOME+ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --delimiter=/ --preview="exa --all --classify --color=always -L=2 -T {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always" --with-nth=4..)') && [ $(echo '$directory') ] && [ -d $(echo '$directory') ] && cd $(echo '$directory')"
alias 1="cd -"
alias 2="cd -2"
alias 3="cd -3"
alias 4="cd -4"
...
alias dh0="git diff HEAD~0 --word-diff=color"
alias dh1="git diff HEAD~1 --word-diff=color"
alias dh2="git diff HEAD~2 --word-diff=color"
alias dh3="git diff HEAD~3 --word-diff=color"
alias dh="git diff HEAD --word-diff=color"
alias dhn="func() { git diff --word-diff=color $(echo 'HEAD~${1:-0} ${@:2}'); }; func"
alias dl="git diff --word-diff=color"
alias dm0="git diff main~0 --word-diff=color"
alias dm1="git diff main~1 --word-diff=color"
alias dm2="git diff main~2 --word-diff=color"
alias dm3="git diff main~3 --word-diff=color"
alias dm="git diff main --word-diff=color"
alias dmn="func() { git diff --word-diff=color $(echo 'main~${1:-0} ${@:2}'); }; func"
...
alias ee="func() { local both=$(echo '$(exa --all --classify --color=always $@ | fzf --ansi --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="if [[ {} == */ ]]; then; exa --all --classify --color=always -L=2 -T {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always; else; bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always; fi")') && [ $(echo '$both') ] && echo $(echo '$both') | tr '\n' '\0' | xargs -0 open --; }; func"
...
alias ii="func() { local files=$(echo '$(git ls-files --others --exclude-standard | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 -I file bash -c 'echo "file" >> \$(git rev-parse --show-toplevel)/.gitignore'; }; func"
...
alias j="func() { local directory=$(echo '$(fd --type d $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --no-multi --preview="exa --all --classify --color=always -L=2 -T {} | grep --color=always -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^)")') && [ $(echo '$directory') ] && [ -d $(echo '$directory') ] && cd $(echo '$directory'); }; func"
alias jt="func() { local directory=$(echo '$(fd --type d $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --no-multi --preview="exa --all --classify --color=always -L=2 -T {} | grep --color=always -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^)")') && [ $(echo '$directory') ] && [ -d $(echo '$directory') ] && cd $(echo '$directory') && local session=$(echo '${1:-${directory##*/}}') && [ $(echo '$session') ] && tmux switch -t $(echo '$session') || tmux new -ds $(echo '$session') && tmux switch -t $(echo '$session') || tmux attach -t $(echo '$session') ; }; func"
alias jj="func() { local directory=$(echo '$(fasd -Rdl | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --delimiter=/ --no-multi --preview="exa --all --classify --color=always -L=2 -T {} | grep --color=always -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^)" --with-nth=4..)') && [ $(echo '$directory') ] && [ -d $(echo '$directory') ] && cd $(echo '$directory'); }; func"
alias jl="func() { local ipynb=$(echo '$(fd --type f --extension ipynb $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --no-multi --preview="jupyter nbconvert --to markdown {} --stdout | bat --style=numbers --color=always -l md | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$ipynb') ] && [ -f $(echo '$ipynb') ] && jupyter lab $(echo '$ipynb'); }; func"
alias jn="func() { local ipynb=$(echo '$(fd --type f --extension ipynb $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --no-multi --preview="jupyter nbconvert --to markdown {} --stdout | bat --style=numbers --color=always -l md | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$ipynb') ] && [ -f $(echo '$ipynb') ] && jupyter notebook $(echo '$ipynb'); }; func"
alias jjt="func() { local directory=$(echo '$(fasd -Rdl | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --delimiter=/ --no-multi --preview="exa --all --classify --color=always -L=2 -T {} | grep --color=always -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^)" --with-nth=4..)') && [ $(echo '$directory') ] && [ -d $(echo '$directory') ] && cd $(echo '$directory') && local session=$(echo '${1:-${directory##*/}}') && [ $(echo '$session') ] && tmux switch -t $(echo '$session') || tmux new -ds $(echo '$session') && tmux switch -t $(echo '$session') || tmux attach -t $(echo '$session'); }; func"
...
alias ne="func() { local files=$(echo '$(n -u NONE -es "+pu =v:oldfiles" +%p +q! | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --delimiter=/ --with-nth=4.. --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 nvim $(echo '$@') --; }; func"
alias nf="func() { local files=$(echo '$(fd --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 nvim --; }; func"
alias nfh="func() { local files=$(echo '$(fd --type f --hidden $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 nvim --; }; func"
alias ng="func() { local file=$(echo '$(rg -l ${@:-^} | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --no-multi --preview="bat --style=plain --color=always {} | rg --color=always -n ${*:-^} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$file') ] && [ -f $(echo '$file') ] && echo $(echo '$file') | sed s+~+$HOME+ | tr '\n' '\0' | xargs -0 nvim +$(echo '$(rg -n ${@:-^} $file | head -n 1 | cut -d: -f1)') --; }; func"
alias nh="n -c History" # this only works with -c, not --cmd
alias nl="func() { local files=$(echo '$(rg -l ${@:-^} | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=plain --color=always {} | rg --color=always -n ${*:-^} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | sed s+~+$HOME+ | tr '\n' '\0' | xargs -0 nvim --; }; func"
alias nn="func() { local files=$(echo '$(fasd -Rfl | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --delimiter=/ --with-nth=4.. --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 nvim $(echo '$@') --; }; func"
alias no="n -c 'browse oldfiles'" # this only works with -c, not --cmd
alias nows="func() {find $(echo '${1-.}') -type f | sed 'p;s/ /_/g' | tr '\n' '\0' | xargs -0n2 mv; }; func"
alias np="func() { local files=$(echo '$(fd -e pdf --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="pdftotext -l 2 {} - | bat --style=numbers --color=always -l md | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 -n1 -I '{}' pdftotext '{}' && echo $(echo '${files//.pdf/.txt}') | tr '\n' '\0' | xargs -0 nvim --; }; func"
alias nr="func() { local files=$(echo '$(rg -e "^> ~/" -e "^> /" ~/.viminfo | cut -c3- | sed s+~+$HOME+ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --delimiter=/ --with-nth=4..)') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 nvim $(echo '$@') --; }; func"
...
alias nw="func() { local files=$(echo '$(fd -e docx --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="pandoc {} -t markdown | bat --style=numbers --color=always -l md | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | sed 's/docx/md/;p;s/md/docx/' | tr '\n' '\0' | xargs -0 -n2 pandoc -f docx -t markdown -o && echo $(echo '${files//docx/md}') | tr '\n' '\0' | xargs -0 nvim --; }; func"
alias nz="n ~/.zshrc"
alias n~="vim -esu NORC \"+pu=execute('digraphs')\" +%p +q! | grep n~ | cut -d ' ' -f38 | pbcopy"
alias o="open"
alias od="func() { local directory=$(echo '$(fd --type d $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="exa --all --classify --color=always -L=2 -T {} | grep --color=always -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^)")') && [ $(echo '$directory') ] && [ -d $(echo '$directory') ] && echo $(echo '$directory') | tr '\n' '\0' | xargs -0 open; }; func"
alias of="func() { local files=$(echo '$(fd --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 open; }; func"
alias oh="func() { local files=$(echo '$(fd -e html --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 open; }; func"
alias oo="func() { local both=$(echo '$(fasd -Ral | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="if [[ \"$(fasd -Rdl)\" =~ {} ]]; then; exa --all --classify --color=always -L=2 -T {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always; else; bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always; fi")') && [ $(echo '$both') ] && echo $(echo '$both') | tr '\n' '\0' | xargs -0 open; }; func"
alias op="func() { local files=$(echo '$(fd -e pdf --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="pdftotext -l 2 {} - | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 open; }; func"
alias or="func() { local files=$(echo '$(fd -e Rproj --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 open; }; func"
alias ow="func() { local files=$(echo '$(fd -e docx --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="pandoc {} -t markdown | bat --style=numbers --color=always -l md | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 open; }; func"
alias p="git push"
alias pc="pycharm"
...
alias pomf="git push origin main --force"
alias pou="git push origin -u" # -u is --set-upstream
alias poum="git push origin -u main" # -u is --set-upstream
alias pp="func() { local files=$(echo '$(fd -e py --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 pycharm; }; func"
...
alias rr="func() { local files=$(echo '$(git diff HEAD --name-only --relative $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="git diff HEAD --color=always --color-words -- {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 git restore --source=HEAD --staged --worktree --; }; func"
alias rrm="git remote remove"
alias rrmo="git remote remove origin"
alias rrmu="git remote remove upstream"
alias rs="func() { local files=$(echo '$(git diff --staged --name-only --relative $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="git diff HEAD --color=always --color-words -- {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 git restore --source=HEAD --staged --; }; func"
...
alias rw="func() { local files=$(echo '$(git diff HEAD --diff-filter=M --name-only --relative $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="git diff HEAD --color=always --color-words -- {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 git restore --source=HEAD --worktree --; }; func"
...
alias t="tmux"
alias tt="func() {local session=$(echo '${1:-${PWD##*/}}') && [ $(echo '$session') ] && tmux switch -t $(echo '$session') || tmux new -ds $(echo '$session') && tmux switch -t $(echo '$session') || tmux attach -t $(echo '$session'); }; func"
...
alias ttk="tmux kill-session -t $(echo '$(tmux list-sessions | fzf --bind="alt-y:execute-silent(echo {1} | pbcopy)" --delimiter=: --no-sort | cut -d: -f1)')"
...
alias ve="func() { local files=$(echo '$(v -es --noplugin -u ~/.vimrc "+set nonumber" "+pu =v:oldfiles" +%p +q! | sed /^.$/d | sed s+~+$HOME+ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --delimiter=/ --with-nth=4.. --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 -o vim $(echo '$@') --; }; func"
alias vf="func() { local files=$(echo '$(fd --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 -o vim --; }; func"
alias vfh="func() { local files=$(echo '$(fd --type f --hidden $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 -o vim --; }; func"
alias vg="func() { local file=$(echo '$(rg -l ${@:-^} | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --no-multi --preview="bat --style=plain --color=always {} | rg --color=always -n ${*:-^} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$file') ] && [ -f $(echo '$file') ] && echo $(echo '$file') | tr '\n' '\0' | xargs -0 -o vim +$(echo '$(rg -n ${@:-^} $file | head -n 1 | cut -d: -f1)') --; }; func"
alias vh="v -c History" # this only works with -c, not --cmd
alias vl="func() { local files=$(echo '$(rg -l ${@:-^} | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="bat --style=plain --color=always {} | rg --color=always -n ${*:-^} | grep --color=always -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^)")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 -o vim --; }; func"
alias vo="n -c 'browse oldfiles'" # this only works with -c, not --cmd
alias vp="func() { local files=$(echo '$(fd -e pdf --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="pdftotext -l 2 {} - | bat --style=numbers --color=always -l md | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 -n1 -I '{}' pdftotext '{}' && echo $(echo '${files//.pdf/.txt}') | tr '\n' '\0' | xargs -0 -o vim --; }; func"
alias vr="func() { local files=$(echo '$(rg -e "^> ~/" -e "^> /" ~/.viminfo | cut -c3- | sed s+~+$HOME+ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --delimiter=/ --with-nth=4.. --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 -o vim $(echo '$@') --; }; func"
...
alias vv="func() { local files=$(echo '$(fasd -Rfl | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --delimiter=/ --with-nth=4.. --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 -o vim $(echo '$@') --; }; func"
alias vw="func() { local files=$(echo '$(fd -e docx --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="pandoc {} -t markdown | bat --style=numbers --color=always -l md | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | sed 's/docx/md/;p;s/md/docx/' | tr '\n' '\0' | xargs -0 -n2 pandoc -f docx -t markdown -o && echo $(echo '${files//docx/md}') | tr '\n' '\0' | xargs -0 -o vim --; }; func"
alias vz="v ~/.zshrc"
alias w="which"
alias ww="func() { local files=$(echo '$(fd -e js --type f $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --delimiter=/ --with-nth=4.. --preview="bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always")') && [ $(echo '$files') ] && echo $(echo '$files') | tr '\n' '\0' | xargs -0 webstorm; }; func"
alias x="git clean -dn"
alias xf="git clean -df"
alias xi="git clean -di"
alias xx="func() {local untracked=$(echo '$(git clean -dfn | sed s/^Would\ remove\ // | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" --preview="if [[ {} == */ ]]; then; exa --all --classify --color=always -L=2 -T {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always; else; bat --style=numbers --color=always {} | grep -E \$([ {q} ] && echo {q} | xargs | sed s/\ /\|/g | sed s/$/\|$/g || echo ^) --color=always; fi")') && [ $(echo '$untracked') ] && echo $(echo '$untracked') | tr '\n' '\0' | xargs -0 git clean -df; }; func"
alias y="fc -ln -1 | pbcopy"
alias yy="func() { local cmds=$(echo '$(fc -ln $@ | fzf --bind="alt-y:execute-silent(echo {} | pbcopy)" -m)') && [ $(echo '$cmds') ] && echo $(echo '$cmds') | pbcopy; }; func"
alias z="fasd -d"
