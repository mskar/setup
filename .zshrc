...
alias d="git diff"
alias db="batdiff"
alias dc="git difftool -y code --extcmd 'code --wait --diff'"
alias dcc="git difftool -y code --extcmd 'code --wait --diff' --cached"
alias dcm="git difftool -y code --extcmd 'code --wait --diff' main"
...
alias dn="git difftool -y --extcmd 'nvim -d'"
alias dnc="git difftool -y --extcmd 'nvim -d' --cached"
alias dnm="git difftool -y --extcmd 'nvim -d' main"
alias dns="git diff --name-status"
alias dp="git difftool -y --extcmd 'pycharm diff $LOCAL $REMOTE'"
alias dps="git difftool -y --extcmd 'pycharm diff'"
