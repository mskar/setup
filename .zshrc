...
alias a\.ca="git add . && git commit --amend --reset-author --reedit-message=HEAD"
...
alias a\.cr="git add . && git commit --reset-author --reuse-message=HEAD"
alias a\.crp="git add . && git commit --reset-author --reuse-message=HEAD && git push"
alias a\.crpf="git add . && git commit --reset-author --reuse-message=HEAD && git push --force-if-includes --force-with-lease"
alias aa="git add --all"
alias aac="git add --all && git commit"
alias aaca="git add --all && git commit --amend --reset-author --reedit-message=HEAD"
...
alias tf="func() { local session=$(echo '${1:-${PWD##*/}}') && [ $(echo '$session') ] && tmux new -ds $(echo '$session'); tmux attach -t $(echo '$session') || tmux switch -t $(echo '$session'); }; func"
alias ti="tmux info"
