...
alias d="git diff"
alias db="batdiff"
alias dc="git difftool --no-prompt --extcmd 'code --wait --diff'"
alias dcc="git difftool --no-prompt --extcmd 'code --wait --diff' --cached"
alias dcm="git difftool --no-prompt --extcmd 'code --wait --diff' main"
alias dcs="git difftool --no-prompt --extcmd 'code --wait --diff' --staged"
...
alias dn="git difftool --no-prompt --extcmd 'nvim -d'"
alias dnc="git difftool --no-prompt --extcmd 'nvim -d' --cached"
alias dnm="git difftool --no-prompt --extcmd 'nvim -d' main"
alias dns="git difftool --no-prompt --extcmd 'nvim -d' --staged" # same as --cached
...
alias hr="gh repo"
alias hrc="func() { git init && gh repo create $(echo '$1') --private $(echo '${@:3}') --confirm; }; func"
alias hrcd="func() { git init && gh repo create $(echo '$1') --private --description \"$(echo '${*# }')\" --confirm; }; func"
alias hrci="func() { git init && gh repo create $(echo '$1') --internal $(echo '${@:2}') --confirm; }; func"
alias hrcid="func() { git init && gh repo create $(echo '$1') --internal --description \"$(echo '${*# }')\" --confirm; }; func"
alias hrcp="func() { git init && gh repo create $(echo '$1') --public $(echo '${@:2}') --confirm; }; func"
alias hrcpd="func() { git init && gh repo create $(echo '$1') --public --description \"$(echo '${*# }')\" --confirm; }; func"
...
alias nd="func() { n $(date '+%Y-%m-%d')_$(echo '$1:-notes').md; }; func"
...
alias rgb="batgrep" # combines ripgrep (rg) and bat
...
alias sA="ssh-add -A"
alias sK="func() { ssh-add -K ~/.ssh/$(echo '$1'); }; func"
...
alias td="func() { local session=$(echo '${1:-${PWD##*/}}') && [ $(echo '$session') ] && tmux new -ds $(echo '$session'); tmux attach -t $(echo '$session') || tmux switch -t $(echo '$session'); }; func" # tmux directory
alias ti="tmux info"
...
alias tjf="func() { local directory=$(echo '$(fasd -Rdl | fzf --delimiter=/ --no-multi --with-nth=4..)') && local session=$(echo '${1:-${directory##*/}}') && [ $(echo '$directory') ] && [ -d $(echo '$directory') ] && [ $(echo '$session') ] && tmux new -ds $(echo '$session') -c $(echo '$directory'); tmux attach -t $(echo '$session') || tmux switch -t $(echo '$session'); }; func"
