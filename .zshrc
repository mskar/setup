...
alias acap="git add --all && git commit --amend --reset-author --reedit-message=HEAD && git push --force-if-includes --force-with-lease"
alias acapf="git add --all && git commit --amend --reset-author --reedit-message=HEAD && git push --force"
...
alias carf="git commit --amend --reset-author --reuse-message=HEAD && git push --force"
