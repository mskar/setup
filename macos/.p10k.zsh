# Generated by Powerlevel10k configuration wizard on 2020-09-05 at 21:50 EDT.
...
() {
  ...
  # Indigo prompt symbol in insert mode
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_FOREGROUND=141
  # Red prompt symbol in Replace mode
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_FOREGROUND=196
  # Viridian/Vert (green) prompt symbol in Visual mode
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_FOREGROUND=82
  # Navy (blue) prompt symbol in Normal mode
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_FOREGROUND=39
