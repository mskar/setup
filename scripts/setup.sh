...
brew install ag bash bat clementtsang/bottom/bottom coreutils diff-so-fancy exa fasd fd fzf gh neovim node noti rename rg sc-im tldr tmux vim xpdf zsh-autosuggestions zsh-syntax-highlighting romkatv/powerlevel10k/powerlevel10k
