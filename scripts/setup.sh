...
brew install ag bash bat clementtsang/bottom/bottom exa fasd fd fzf gh neovim node rename rg sc-im tmux vim xpdf zsh-autosuggestions zsh-syntax-highlighting romkatv/powerlevel10k/powerlevel10k
