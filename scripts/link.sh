...
ln -sf ~/maptv/setup/.tmux.conf ~/.tmux.conf
ln -sf ~/maptv/setup/.tmux.conf.local ~/.tmux.conf.local
ln -sf ~/maptv/setup/.vimrc ~/.vimrc
ln -sf ~/maptv/setup/.zshrc ~/.zshrc
ln -sf ~/maptv/setup/DefaultKeyBinding.dict ~/Library/KeyBindings/DefaultKeyBinding.dict
ln -sf ~/maptv/setup/addins.json ~/.config/rstudio/keybindings/addins.json
...
ln -sf ~/maptv/setup/init.lua ~/.hammerspoon/init.lua
...
ln -sf ~/maptv/setup/macos.terminal ~/macos.terminal
ln -sf ~/maptv/setup/config.lua ~/.config/lvim/config.lua
ln -sf ~/maptv/setup/myspacevim.vim ~/.SpaceVim.d/autoload/myspacevim.vim
ln -sf ~/maptv/setup/packages.el ~/.config/doom/packages.el
mkdir -p ~/.config/nvim/plugged/vim-pandoc-syntax/syntax
ln -sf ~/maptv/setup/pandoc.vim ~/.config/nvim/plugged/vim-pandoc-syntax/syntax/pandoc.vim
...
ln -sf ~/maptv/setup/undead.keylayout ~/Library/Keyboard\ Layouts/undead.keylayout
